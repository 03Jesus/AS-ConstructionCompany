...
CONSTRUCTION_HOUSE = "Construction House"
...
class TestProject(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.em1 = Employee(1, "Juan", "Perez", "12345678",
                            "juan@perez.com", "constructor")
        self.em2 = Employee(2, "Pedro", "Gomez", "87654321",
                            "pedro@gomez.com", "constructor")
        self.payroll = Payroll([self.em1, self.em2])

        self.children = [self.client, self.equipment,
                         self.schedule, self.payroll]

        self.project1 = Project(1, CONSTRUCTION_HOUSE,
                                "description", self.children)

        self.project2 = Project(1, CONSTRUCTION_HOUSE,
                                "description", self.children)

    def test_constructor(self):

        self.assertEqual(self.project1.id, 1)
        self.assertEqual(self.project1.name, CONSTRUCTION_HOUSE)
